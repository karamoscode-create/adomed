...
class AppColors {
// Le dégradé va maintenant vers la couleur secondaire (un bleu ciel).
...
static const Color secondaryColor = Color(0xFF42A5F5); // Cette couleur est maintenant utilisée dans le dégradé
...
fontSize: 20,
// MODIFIÉ : Titres des pages bien en gras
...
displayLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
displayMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
displaySmall: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
headlineLarge: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
headlineMedium: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
headlineSmall: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
titleLarge: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
titleMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: textPrimaryColor, fontFamily: 'Mulish'),
titleSmall: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: textSecondaryColor, fontFamily: 'Mulish'),
// MODIFIÉ : Texte des posts plus épais (semi-gras)
bodyLarge: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: textPrimaryColor, fontFamily: 'Mulish'),
bodyMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: textPrimaryColor, fontFamily: 'Mulish'),
bodySmall: TextStyle(fontSize: 12, fontWeight: FontWeight.normal, color: textSecondaryColor, fontFamily: 'Mulish'),
labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: textPrimaryColor, fontFamily: 'Mulish'),
labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: textSecondaryColor, fontFamily: 'Mulish'),
labelSmall: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: textHintColor, fontFamily: 'Mulish'),
),
